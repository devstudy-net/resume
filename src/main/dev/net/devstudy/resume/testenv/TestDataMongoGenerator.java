...
public class TestDataMongoGenerator {
    ...
    private static void createProfile(MongoClient mongo, Profile profile, ProfileConfig profileConfig, Map<String, Integer> map, List<Certificate> certificates) throws IOException {
    ...
    private static BasicDBList insertSkills(MongoClient mongo, Map<String, Integer> map, ProfileConfig profileConfig) {
    ...
    private static BasicDBList insertPractics(MongoClient mongo, ProfileConfig profileConfig) {
        BasicDBList list = new BasicDBList();
    ...
    private static BasicDBList insertCertificates(MongoClient mongo, int certificatesCount, List<Certificate> certificates) throws IOException {
    ...
    private static BasicDBObject insertProfileData(MongoClient mongo, Profile profile, ProfileConfig profileConfig) throws IOException {
    ...
    private static Map<String, Integer> insertSkillCategories(MongoClient mongo) {
